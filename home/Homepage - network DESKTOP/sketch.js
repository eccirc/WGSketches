...
const transformer = 1.5 // 2 is what's on the current desktop mode iframe // 0.5 300,160
const bannerTransformer = 3.2;
const sizeOfBalls = 10;
const sideShifter = -35;
const verticalShifter = -13;

// real canvas is these ones
const widthForSetup = 575;
const heightForSetup = 490;
