...
var main = (p) => {
  ...
  p.draw = () => {
    ...
    // carriers
    drawCarrier(5, 0, 0, 50, 250, 100, p);
    drawCarrier(5, 1, 0, 50, 250, 100, p);
    drawCarrier(5, 3, 0, 50, 250, 100, p);
    drawCarrier(5, 4, 0, 50, 250, 100, p);
    drawCarrier(5, 2, 0, 50, 250, 100, p);
    ...
    drawArrow(5, 0, true, 0.1, 0, 50, 180, 150, p);
    drawArrow(5, 1, true, 0.2, 0, 50, 180, 150, p);
    drawArrow(5, 3, true, 0.5, 0, 50, 180, 150, p);
    drawArrow(5, 4, true, 0.5, 0, 50, 180, 150, p);
    drawArrow(5, 2, true, 0.5, 0, 50, 180, 150, p);
...
function thankYouMessage(indexFriendThanking, p) {
  ...
  p.stroke(20, 20, 20)
  p.strokeWeight(1);
  p.ellipse(particlesArray[indexFriendThanking].xMoving + 50, particlesArray[indexFriendThanking].yMoving - 5, 80, 40)
  p.fill(30, 0, 0)
  p.noStroke();
  p.textFont(amaticFont);
  p.textSize(30);
  p.text("thanks!", particlesArray[indexFriendThanking].xMoving + 18, particlesArray[indexFriendThanking].yMoving + 5)
}
