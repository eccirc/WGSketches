...
function thankYouMessage(indexFriendThanking, p) {
  ...
  p.stroke(20, 20, 20)
  p.strokeWeight(1);
  p.ellipse(particlesArray[indexFriendThanking].xMoving + 50, particlesArray[indexFriendThanking].yMoving - 10, 80, 40)
  p.fill(30, 0, 0)
  p.noStroke();
  p.textFont(amaticFont);
  p.textSize(30);
  p.text("thanks!", particlesArray[indexFriendThanking].xMoving + 18, particlesArray[indexFriendThanking].yMoving)
}
