...
var main = (p) => {
  ...
  p.draw = () => {
    ...
    drawArrow(0, 1, false, 0.3, 0, 50, 180, 150, 21, p)
    drawArrow(0, 3, false, 0.3, 0, 50, 180, 150, 16, p)
    drawArrow(0, 7, false, 0.3, 0, 50, 180, 150, 5, p)
    drawArrow(0, 9, false, 0.3, 0, 50, 180, 150, 14, p)
    drawArrow(0, 12, false, 0.3, 0, 50, 180, 150, 10, p)
    drawArrow(0, 13, false, 0.3, 0, 50, 180, 150, 7, p)
    drawArrow(0, 14, false, 0.3, 0, 50, 180, 150, 3, p)
