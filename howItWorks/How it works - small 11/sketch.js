...
var main = (p) => {
  ...
  p.draw = () => {
    ...
    // arrows
    drawArrow(1, 0, false, 0.2, 0, 180, 50, 150, particlesArray[1].receivedFrom, p)
    drawArrow(2, 0, false, 0.2, 0, 180, 50, 150, particlesArray[2].receivedFrom, p)
    drawArrow(3, 0, false, 0.2, 0, 180, 50, 150, particlesArray[3].receivedFrom, p)
    drawArrow(4, 0, false, 0.2, 0, 180, 50, 150, particlesArray[4].receivedFrom, p)
    drawArrow(5, 0, false, 0.2, 0, 180, 50, 150, particlesArray[5].receivedFrom, p)
    drawArrow(6, 0, false, 0.2, 0, 180, 50, 150, particlesArray[6].receivedFrom, p)
    drawArrow(7, 0, false, 0.2, 0, 180, 50, 150, particlesArray[7].receivedFrom, p)
    drawArrow(9, 0, false, 0.2, 0, 180, 50, 150, particlesArray[9].receivedFrom, p)
    drawArrow(10, 0, false, 0.2, 0, 180, 50, 150, particlesArray[10].receivedFrom, p)
    drawArrow(11, 0, false, 0.2, 0, 180, 50, 150, particlesArray[11].receivedFrom, p)
    drawArrow(13, 0, false, 0.2, 0, 180, 50, 150, particlesArray[13].receivedFrom, p)
    drawArrow(15, 0, false, 0.2, 0, 180, 50, 150, particlesArray[15].receivedFrom, p)
