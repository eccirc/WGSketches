  ...
  p.draw = () => {
    ...
    switch (step) {
      ...
      case 5:
        ...
        drawCarrier(0, 4, 1, particlesArray[4].colourR, particlesArray[4].colourG, particlesArray[4].colourB, 100)
        drawArrow(0, 4, false, 3, particlesArray[4].colourR, particlesArray[4].colourG, particlesArray[4].colourB, 150, 15)
      ...
      case 11:
        ...
        particlesArray.forEach(element => {
          ...
          particlesArray[5].thisInfoBannerOn = true;
        })
